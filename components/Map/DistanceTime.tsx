...
function DistanceTime() {
  ...
  return directionData?.routes&&(
    <div className='bg-yellow-500 p-3'>
      <h2 className='text-yellow-100 opacity-80 text-[15px] '> Distance:<span className='font-bold mr-3 text-black'>
        {(directionData?.routes[0]?.distance*0.000621371192).toFixed(2)}Miles</span>
